        ...
        <div class="ep-body">
            ...
            <div class="ep-field ep-full">
                ...
                <div class="ep-select-wrap">
                    ...
                    <svg class="ep-select-arrow" width="13" height="13" viewBox="0 0 24 24" fill="none"
            ...
            <div class="ep-field">
                ...
                <div class="ep-input-wrap">
                    ...
                    <input type="number" id="ep_min_price" name="min_price" placeholder="0.00" step="0.01" min="0"
            ...
            <div class="ep-field">
                ...
                <div class="ep-input-wrap">
                    <span class="ep-prefix">₹</span>
                    <input type="number" id="ep_max_price" name="max_price" placeholder="9999.00" step="0.01" min="0"
            ...
            <div class="ep-field">
                ...
                <input type="number" id="ep_min_stock" name="min_stock" placeholder="0" min="0"
                    value="{{ request('min_stock') }}">
            </div>

            <div class="ep-field">
                <label for="ep_max_stock">Max stock</label>
                <input type="number" id="ep_max_stock" name="max_stock" placeholder="999" min="0"
